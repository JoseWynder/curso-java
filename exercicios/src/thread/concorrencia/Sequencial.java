...
public class Sequencial {
    ...
    public static void main(String[] args) {
    	...
    	for (int i = 0; i < 2; i++) {
            tempo(Sequencial::SomaSequencial);
        }
        ...
        System.out.printf("Tempo de execucao Sequencial:\n");
        for (int i = 0; i < execucoes; i++) {
        	double tempoSequencial = tempo(Sequencial::SomaSequencial);
        	tempos[i] = tempoSequencial;
        	somaTempos += tempoSequencial;
